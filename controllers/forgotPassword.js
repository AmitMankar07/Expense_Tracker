...
exports.forgotpassword = async (req, res) => {
    try {
        ...
        if (user) {
            const link = `http://16.171.220.37:3000/password/resestpassword/${uuid}`;
...
exports.sendForm = async (req, res, next) => {
    ...
    const htmlContent = `
        <form action="http://16.171.220.37:3000/password/resestpassword/${uuid}" method="POST" id="reset-passsword-form" class="form"> 
        ...
        <script>
            document.getElementById("reset-passsword-form").addEventListener("submit", async (e) => {
                ...
                try {
                    const response = await axios.post('http://16.171.220.37:3000/password/resestpassword/${uuid}', { pass: password });
