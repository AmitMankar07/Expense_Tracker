...
btnLeaderBoard.onclick = async () => {
    try {
        ...
        const response = await axios.get("http://16.171.220.37:3000/premium/showleaderboard", {
...
btnDownload.onclick=async function(){
    try{
     const response=  await  axios.get('http://16.171.220.37:3000/users/download', { headers: {"Authorization" : token} });
    ...
    document.getElementById('premium').onclick=async function(e){
        ...
        try{
            ...
            const response=await axios.get('http://16.171.220.37:3000/users/premium/premiummembership',{
            headers:{'Authorization':token}});
        ...
        var options={
            ...
            "handler":async function (response){
                await axios.post('http://16.171.220.37:3000/users/premium/updateTransactionStatus',{
...
async function displayDownloadHistory() {
    try {
        ...
        const response = await axios.get('http://16.171.220.37:3000/premium/alldownloadhistory', { headers: { "Authorization": token } });
        console.log(response);
